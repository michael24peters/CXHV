...
!panel: HV_Domain_v1.pnl
    state: NOT_READY
    !color: FwStateAttention1
        when ( any_in HV_DOMAIN_V1_FWSETSTATES in_state {ERROR,EMERGENCY_OFF} )  move_to ERROR
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_STANDBY1,STANDBY1} )  move_to RAMPING_STANDBY1
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_STANDBY2,STANDBY2} )  move_to RAMPING_STANDBY2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_READY,READY} )  move_to RAMPING_READY
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_OFF,OFF} )  move_to RAMPING_OFF
        action: Go_OFF	!visible: 1
            do Go_OFF all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_OFF, OFF} ) then
                move_to NOT_READY
            endif
            move_to RAMPING_OFF
        action: Go_STANDBY1(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Go_STANDBY1(RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_STANDBY1, STANDBY1} ) then
                move_to NOT_READY
            endif
            move_to RAMPING_STANDBY1
        action: Go_STANDBY2(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Go_STANDBY2(RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_STANDBY2, STANDBY2} ) then
                move_to NOT_READY
            endif
            move_to RAMPING_STANDBY2
        action: Go_READY(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Go_READY(RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_READY, READY} )  then
                    move_to NOT_READY
            endif
            move_to RAMPING_READY
        action: Do_Emergency_OFF	!visible: 1
            do Do_Emergency_OFF all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state EMERGENCY_OFF )  then
              move_to ERROR
            endif
            move_to EMERGENCY_OFF
        action: Load(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Reset all_in HV_DOMAIN_V1_FWSETACTIONS
            do LOAD(RUN_TYPE=RUN_TYPE,sMode=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            move_to NOT_READY
        action: Reset	!visible: 1
            do Reset all_in HV_DOMAIN_V1_FWSETACTIONS
            move_to NOT_READY
    ...
    !color: FwStateOKNotPhysics
        ...
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_STANDBY2,STANDBY2} )  move_to RAMPING_STANDBY2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_READY,READY} )  move_to RAMPING_READY
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state OFF )  move_to NOT_READY
        action: Go_STANDBY1(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Go_STANDBY1(RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_STANDBY1, STANDBY1} ) then
                move_to NOT_READY
    ...
    state: RAMPING_STANDBY1
    !color: FwStateAttention2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state STANDBY1 )  move_to STANDBY1
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_STANDBY1,STANDBY1} )  move_to NOT_READY
        action: Do_Emergency_OFF	!visible: 1
            do Do_Emergency_OFF all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state EMERGENCY_OFF )  then
              move_to ERROR
    ...
    !color: FwStateOKNotPhysics
        ...
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_STANDBY2,STANDBY2} )  move_to RAMPING_STANDBY2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_READY,READY} )  move_to RAMPING_READY
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state STANDBY1 )  move_to NOT_READY
        action: Go_STANDBY2(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Go_STANDBY2(RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_STANDBY2, STANDBY2} ) then
                move_to NOT_READY
    ...
    state: RAMPING_STANDBY2
    !color: FwStateAttention2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state STANDBY2 )  move_to STANDBY2
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_STANDBY2,STANDBY2} )  move_to NOT_READY
        action: Do_Emergency_OFF	!visible: 1
            do Do_Emergency_OFF all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state EMERGENCY_OFF )  then
              move_to ERROR
    ...
    !color: FwStateOKNotPhysics
        ...
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_READY,READY} )  move_to RAMPING_READY
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_OFF,OFF} )  move_to RAMPING_OFF
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state STANDBY2 )  move_to NOT_READY
        action: Go_READY(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Go_READY(RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_READY, READY} )  then
                    move_to NOT_READY
    ...
    state: RAMPING_READY
    !color: FwStateAttention2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state READY )  move_to READY
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_READY,READY} )  move_to NOT_READY
        action: Do_Emergency_OFF	!visible: 1
            do Do_Emergency_OFF all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state EMERGENCY_OFF )  then
              move_to ERROR
            ...
            move_to EMERGENCY_OFF
        action: FAKE_READY	!visible: 1
            do FAKE_READY all_in HV_DOMAIN_V1_FWSETACTIONS
            move_to READY
        action: Go_OFF	!visible: 1
            do Go_OFF all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_OFF, OFF} ) then
    ...
    !color: FwStateOKPhysics
        ...
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_STANDBY2,STANDBY2} )  move_to RAMPING_STANDBY2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state {RAMPING_OFF,OFF} )  move_to RAMPING_OFF
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state READY )  move_to NOT_READY
        action: Go_STANDBY2(string RUN_TYPE = "PHYSICS")	!visible: 1
            do Go_STANDBY2(RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_STANDBY2, STANDBY2} ) then
                move_to NOT_READY
        ...
        action: Reset	!visible: 1
            ...
            move_to NOT_READY
        action: Step(int STEP_NR = 0, string RUN_TYPE = "")	!visible: 1
            do Step(STEP_NR=STEP_NR, RUN_TYPE=RUN_TYPE) all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( all_in HV_DOMAIN_V1_FWSETSTATES not_in_state READY ) then
                move_to NOT_READY
            endif
            move_to READY
        action: Go_READY(string RUN_TYPE = "PHYSICS")	!visible: 1
    ...
    state: RAMPING_OFF
    !color: FwStateAttention2
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state OFF )  move_to OFF
        when ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state {RAMPING_OFF,OFF} )  move_to NOT_READY
        action: Do_Emergency_OFF	!visible: 1
            do Do_Emergency_OFF all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES not_in_state EMERGENCY_OFF )  then
              move_to ERROR
    ...
    state: ERROR
    !color: FwStateAttention3
        when ( all_in HV_DOMAIN_V1_FWSETSTATES in_state EMERGENCY_OFF )  move_to EMERGENCY_OFF
        when ( all_in HV_DOMAIN_V1_FWSETSTATES not_in_state {ERROR,EMERGENCY_OFF} )  move_to NOT_READY
        action: RECOVER	!visible: 1
            do RECOVER all_in HV_DOMAIN_V1_FWSETACTIONS
            if ( any_in HV_DOMAIN_V1_FWSETSTATES in_state ERROR ) then
                move_to ERROR
            endif
            move_to NOT_READY
        action: Do_Emergency_OFF	!visible: 1
    ...
    state: EMERGENCY_OFF
    !color: FwStateAttention3
        when ( all_in HV_DOMAIN_V1_FWSETSTATES not_in_state EMERGENCY_OFF )  move_to NOT_READY
        action: Clear_Emergency	!visible: 1
            do Clear_Emergency all_in HV_DOMAIN_V1_FWSETACTIONS
            move_to NOT_READY
...
objectset: FWCHILDREN_FWSETACTIONS union {HV_DOMAIN_V1_FWSETACTIONS } is_of_class VOID
objectset: FWCHILDREN_FWSETSTATES union {HV_DOMAIN_V1_FWSETSTATES } is_of_class VOID
