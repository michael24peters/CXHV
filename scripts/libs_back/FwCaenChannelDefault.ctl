FwCaenChannelDefault_initialize(string domain, string device)
{
}

FwCaenChannelDefault_valueChanged( string domain, string device,
...
FwCaenChannelDefault_doCommand(string domain, string device, string command)
{ 
string runType; 
