FwCaenChannelA1580_initialize(string domain, string device)
{
}

FwCaenChannelA1580_valueChanged( string domain, string device,
...
FwCaenChannelA1580_doCommand(string domain, string device, string command)
{ 
string runType; 
